...
def reactor_efficiency(voltage: int, current: int, theoretical_max_power: int) -> str:
    ...
    percent: float = (generated_power / theoretical_max_power) * 100
...
def fail_safe(temperature: int, neutrons_produced_per_second: int, threshold: int) -> str:
    ...
    product: int = temperature * neutrons_produced_per_second
    lower_bound: float = threshold * 0.9
    upper_bound: float = threshold * 1.1
